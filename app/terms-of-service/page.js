          ...
          <div>
            ...
            <p>
              {isItalian
                ...
                : "Careloop provides an AI-based virtual assistant that integrates with your website to automatically answer FAQs, suggest sizes, search products, and offer customer care features."}
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              {isItalian
                ...
                : "To use the service, you must: provide a valid email address, complete monthly payment, and accept these Terms. Users are responsible for the accuracy of their data and lawful use of the service."}
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              {isItalian
                ...
                : "Careloop operates on a monthly subscription basis. Coverage: 30 days. Cancellation: anytime before renewal. Refunds: not provided for unused time."}
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              {isItalian
                ...
                : "We grant a non-exclusive, non-transferable, and revocable license for lawful commercial use on your own website. All rights to the software remain the property of Careloop."}
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              {isItalian
                ...
                : "Careloop is an automated AI-based tool. Answers may not always be accurate. Users are responsible for customer interactions. Careloop shall not be held liable for direct or indirect damages. The service is provided 'as is' with no guarantee of specific outcomes."}
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              {isItalian
                ...
                : "We reserve the right to modify, suspend, or update the service at any time. In case of substantial changes, users will be notified by email."}
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              {isItalian
                ...
                : "Data is processed in accordance with the GDPR (EU Reg. 2016/679). For details, see our Privacy Policy and Cookie Policy."}
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              {isItalian
                ...
                : "Careloop may not be used for illegal, offensive, or misleading purposes, fraudulent automation, or technical interference. Violations may result in immediate suspension of the service."}
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              {isItalian
                ...
                : "Users may cancel the service at any time. Cancellation takes effect at the end of the paid period."}
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              {isItalian
                ...
                : "These Terms are governed by Italian law. Any dispute shall be subject to the exclusive jurisdiction of the Court of Ravenna."}
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              {isItalian
                ...
                : "For questions regarding the Terms of Service, contact info@careloopai.com."}
            </p>
          </div>
        </section>
      </div>
